            ...
            <CardContent className="space-y-6 pt-6">
              <div className="space-y-2">
                ...
                <input
                  ...
                  className="w-full px-4 py-3 bg-white border border-blue-600/30 rounded-lg text-black placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent transition-all"
                  min="0"
                  step="0.01"
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <textarea
                  ...
                  className="w-full px-4 py-3 bg-white border border-blue-600/30 rounded-lg text-black placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent transition-all resize-none"
                  rows={3}
                />
              </div>
